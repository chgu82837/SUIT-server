class Admin::ClothingsController < Admin::BaseController
  ...
  def create
    ...
    respond_to do |format|
      if @clothing.save
        format.html { redirect_to admin_clothing_path(@clothing), notice: 'Clothing was successfully created.' }
        format.json { render :show, status: :created, location: admin_clothing_path(@clothing) }
      else
  ...
  def destroy
    @clothing.destroy
    respond_to do |format|
      format.html { redirect_to admin_clothings_path, notice: 'Clothing was successfully destroyed.' }
  ...
  private
    ...
    def clothing_params
      params.require(:clothing).permit(:name,:chosen,:recommended)
    end
end
