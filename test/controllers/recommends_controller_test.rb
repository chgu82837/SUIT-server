...
class RecommendsControllerTest < ActionController::TestCase
  ...
  test "should create recommend" do
    assert_difference('Recommend.count') do
      post :create, recommend: { clothing_id: @recommend.clothing_id, day: @recommend.day, user_id: @recommend.user_id }
    end
  ...
  test "should update recommend" do
    patch :update, id: @recommend, recommend: { clothing_id: @recommend.clothing_id, day: @recommend.day, user_id: @recommend.user_id }
    assert_redirected_to recommend_path(assigns(:recommend))
  end
